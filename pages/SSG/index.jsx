...
import lois from '../../assets/image/Ellipse 325.png'
...
export async function getStaticProps() {
    const res = await axios.get("https://peeworld-be.vercel.app/users");
    return {
                    ...
                    >
                        ...
                        <div className="col-md-6" id="pro">
                            ...
                            <div className="row d-flex align-items-center m-0" id="loc">
                                ...
                                />
                                <p style={{ marginTop: 13, color: "#9EA0A5" }}>{user_worker.domisili}</p>
                            </div>

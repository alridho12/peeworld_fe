...
import Modaldeleteexp from '../modal/Modaldeletexp';


const PfwexperienceEdit = () => {
        ...
        <div>
            {experience?.map((pengalaman_kerja,index) => (
                <div key={index} className='row m-0'>
                    ...
                    <div className=''>
                        <Modaldeleteexp experience_id={pengalaman_kerja.experience_id} />
                    </div>
                </div>
            ))}
            <hr />
...
export default PfwexperienceEdit